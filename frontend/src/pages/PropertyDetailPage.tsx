...
export function PropertyDetailPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-8 lg:px-10 lg:py-10">
      ...
      <div className="mt-7 grid gap-2 overflow-hidden rounded-2xl bg-slate-100 md:grid-cols-2">
      ...
      <div className="mt-8 grid gap-10 lg:grid-cols-[1fr_280px]">
        <section>
          <div className="flex items-start justify-between gap-5">
            ...
            <p className="whitespace-nowrap text-xl font-semibold text-slate-950">{formatPrice(property.price, property.currency)}</p>
          </div>
